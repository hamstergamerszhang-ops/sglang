...
def build_load_config(
    *,
    server_args: ServerArgs,
    tp_rank: int,
    remote_instance_weight_transport_engine: Any,
    remote_instance_weight_transport_session_id: str,
    ...
    return LoadConfig(
        ...
        remote_instance_weight_loader_transfer_engine=remote_instance_weight_transport_engine,
        remote_instance_weight_loader_transfer_engine_session_id=remote_instance_weight_transport_session_id,
